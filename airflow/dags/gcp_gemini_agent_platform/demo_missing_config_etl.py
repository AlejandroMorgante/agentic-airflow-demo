...
def collect_failure_context(**context: Any) -> str:
    return collect_failure_context_payload(
        "gcp_gemini_agent_platform/demo_missing_config_etl.py",
...
with DAG(
    dag_id="gcp_agentengine_demo_missing_config_etl",
    start_date=pendulum.datetime(2026, 1, 1, tz="UTC"),
    schedule=None,
    catchup=False,
    tags=["agentic-airflow", "gcp", "agentengine", "demo", "config"],
):
    ...
    [start, resolve_config, load_summary] >> failure_context >> troubleshoot >> check_troubleshooting
